        ...
        return this.props.inputs.map(
            ({
                ...
                switch (type) {
                    ...
                    case "radio":
                        const radioMarkup = radioValues.map(
                            ({ radioValue, message }) => (
                                <Field
                                    name={name}
                                    component={Radio}
                                    {...{ name, radioValue, message }}
                                />
                            )
                        );
                        return (
                        ...
                        return (
                            <Field
                                ...
                                {...{
                                    name,
                                    label,
                                    defaultImages: this.props.initialValues
                                        .images,
                                }}
                            />
                        );
    ...
    validate = values => {
        ...
        this.props.inputs.map(({ name, type, optional }) => {
            ...
            if (
                ...
                values[name] === "defaultSelect"
            ) {
                return (errors[name] = `${capitalizeFirstLetter(
                    name
                )} is required.`);
    ...
    render() {
        return (
            <Form
                ...
                initialValues={
                    this.props.initialValues ? this.props.initialValues : null
                }
